...
export const getAuthLoaded = createSelector(selectRoot, root => root.authLoaded)
export const getAuthLoggedIn = createSelector(selectRoot, root => root.authLoggedIn)
