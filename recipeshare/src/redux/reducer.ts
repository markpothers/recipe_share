...
// 			return { ...currentState, recipe_details: { ...currentState.recipe_details, recipe_shares: currentState.recipe_details.re_shares + 1, shareable: false } }
// 		case "REMOVE_RECIPE_SHARE":
// 			return { ...currentState, recipe_details: { ...currentState.recipe_details, recipe_shares: currentState.recipe_details.re_shares - 1, shareable: true } }
// 		case "ADD_MAKE_PIC":
...
// 			return { ...currentState, chef_details: { ...currentState.chef_details, [action.chefID]: action.chef_details } }
