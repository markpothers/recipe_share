...
describe("Recipe Card", () => {
	...
	// test('can be rendered using typical props and matches its previous image - 1', () => {
	// 	const testProps = mockRecipeList.recipes.find(p => p.name.includes("TEST:NORMAL"))
	...
	// 	const testProps = mockRecipeList.recipes.find(p => p.name.includes("TEST:NORMAL2"))
	// 	component = renderer.create(<RecipeCard {...testProps} />)
	// 	const image = component.toJSON()
	// 	expect(image).toMatchSnapshot()
	// })
	...
	// 	const testProps = mockRecipeList.recipes.find(p => p.name.includes("TEST:NORMAL4"))
	// 	component = renderer.create(<RecipeCard {...testProps} />)
	// 	const image = component.toJSON()
	// 	expect(image).toMatchSnapshot()
	// })
	...
	// 	const testProps = mockRecipeList.recipes.find(p => p.name.includes("TEST:NORMAL5"))
	// 	component = renderer.create(<RecipeCard {...testProps} />)
	// 	const image = component.toJSON()
	// 	expect(image).toMatchSnapshot()
	// })
	...
	// 	const testProps = mockRecipeList.recipes.find(p => p.name.includes("TEST:NORMAL6"))
	// 	component = renderer.create(<RecipeCard {...testProps} />)
	// 	const image = component.toJSON()
	// 	expect(image).toMatchSnapshot()
	// })
	...
	// 	const testProps = mockRecipeList.recipes.find(p => p.name.includes("TEST:LIKED"))
	// 	component = renderer.create(<RecipeCard {...testProps} />)
	// 	const image = component.toJSON()
	// 	expect(image).toMatchSnapshot()
	// })
	...
	// 	const testProps = mockRecipeList.recipes.find(p => p.name.includes("TEST:COMMENTED"))
	// 	component = renderer.create(<RecipeCard {...testProps} />)
	// 	const image = component.toJSON()
	// 	expect(image).toMatchSnapshot()
	// })
	...
	// 	const testProps = mockRecipeList.recipes.find(p => p.name.includes("TEST:SHARED"))
	// 	component = renderer.create(<RecipeCard {...testProps} />)
	// 	const image = component.toJSON()
	// 	expect(image).toMatchSnapshot()
	// })
	...
	// 	const testProps = mockRecipeList.recipes.find(p => p.name.includes("TEST:ALL"))
	// 	component = renderer.create(<RecipeCard {...testProps} />)
	// 	const image = component.toJSON()
	// 	expect(image).toMatchSnapshot()
	// })
	...
	// 	const testProps = mockRecipeList.recipes.find(p => p.name.includes("TEST:LONGRECIPENAME"))
	// 	component = renderer.create(<RecipeCard {...testProps} />)
	// 	const image = component.toJSON()
	// 	expect(image).toMatchSnapshot()
	// })
	...
	// 	const testProps = mockRecipeList.recipes.find(p => p.name.includes("TEST:NOCOVERIMAGE"))
	// 	component = renderer.create(<RecipeCard {...testProps} />)
	// 	const image = component.toJSON()
	// 	expect(image).toMatchSnapshot()
	// })
	...
	// 	const testProps = mockRecipeList.recipes.find(p => p.name.includes("TEST:RESHAREDBY"))
	// 	component = renderer.create(<RecipeCard {...testProps} />)
	// 	const image = component.toJSON()
	// 	expect(image).toMatchSnapshot()
	// })
	...
	// 	const testProps = mockRecipeList.recipes.find(p => p.name.includes("TEST:LONGRESHARERUSERNAME"))
	// 	component = renderer.create(<RecipeCard {...testProps} />)
	// 	const image = component.toJSON()
	// 	expect(image).toMatchSnapshot()
	// })
	...
	// 	const testProps = mockRecipeList.recipes.find(p => p.name.includes("TEST:LONGUSERNAME"))
	// 	component = renderer.create(<RecipeCard {...testProps} />)
	// 	const image = component.toJSON()
	// 	expect(image).toMatchSnapshot()
	// })
	...
	// 	const testProps = mockRecipeList.recipes.find(p => p.name.includes("TEST:NOCHEFIMAGE"))
	// 	component = renderer.create(<RecipeCard {...testProps} />)
	// 	const image = component.toJSON()
	// 	expect(image).toMatchSnapshot()
	// })
	...
	// 	const testProps = mockRecipeList.recipes.find(p => p.name.includes("TEST:RESHARED"))
	// 	component = renderer.create(<RecipeCard {...testProps} />)
	...
	// 	jest.useFakeTimers()
	// 	const testProps = mockRecipeList.recipes.find(p => p.name.includes("TEST:OFFLINEMESSAGE"))
	// 	const mockFn = jest.fn()
