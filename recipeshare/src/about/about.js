					...
					<View style={centralStyles.formInputContainer}>
						{this.state.displayingLicenses ? (
							<View style={[centralStyles.greenRectangleButton, styles.viewButton]}>
								...
								<Text maxFontSizeMultiplier={2} style={[centralStyles.yellowButtonText, { fontSize: responsiveFontSize(2.2) }]}>Vew licenses</Text>
							</View>
						) : (
							<TouchableOpacity style={[centralStyles.yellowRectangleButton, styles.viewButton]} activeOpacity={0.7} onPress={this.viewLicenses}>
								...
								<Text maxFontSizeMultiplier={2} style={[centralStyles.greenButtonText, { fontSize: responsiveFontSize(2.2) }]}>Vew licenses</Text>
							</TouchableOpacity>
						)}
					</View>
				</View>
