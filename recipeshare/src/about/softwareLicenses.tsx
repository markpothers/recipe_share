...
export const SoftwareLicenses = () => {
	return (
		<View style={{ width: "100%", padding: responsiveWidth(2), height: "100%" }}>
			<Text style={{ fontSize: responsiveFontSize(2.2) }}>Recipe-Share for {Platform.OS}</Text>
			<Text style={{ fontSize: responsiveFontSize(2.2) }}>
				Copyright &#169; {new Date().getFullYear()} Recipe-Share LLC. All rights reserved.
			</Text>
			<Text style={{ fontSize: responsiveFontSize(2.2) }}>
				Recipe-Share for {Platform.OS} is built using these open-source packages and their licenses:
			</Text>
