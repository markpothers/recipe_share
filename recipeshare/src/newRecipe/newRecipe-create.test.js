...
describe("New Recipe page", () => {
	describe("New Recipe creation and functions", () => {
		...
		beforeEach(async () => {
			...
			await waitFor(async () => await expect(queryAllByTestId("activityIndicator").length).toEqual(0));
		});
	...
	describe("finishing a saved recipe recipe with images", () => {
		...
		// it's basically impossible to test these functions.  I'm just leaving them here as a reminder
