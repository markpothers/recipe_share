			...
			<View style={[centralStyles.formInputContainer, { width: responsiveWidth(100) }]}>
				...
				<TouchableOpacity
					style={[
						...
						{ width: "9%", backgroundColor: this.props.instructionImagePresent ? "#505050" : "white" },
					]}
					activeOpacity={0.7}
					onPress={() => this.props.chooseInstructionPicture(this.props.index)}
					testID={`photo-instruction${this.props.index + 1}`}
				>
					<Icon
						name="camera"
						...
						style={[
							...
							{ color: this.props.instructionImagePresent ? "white" : "#505050" },
						]}
					/>
				</TouchableOpacity>
				<TouchableOpacity
					style={[styles.deleteInstructionContainer, { width: "9%" }]}
					onPress={() => this.props.removeInstruction(this.props.index)}
					activeOpacity={0.7}
					testID={`delete-instruction${this.props.index + 1}`}
				>
