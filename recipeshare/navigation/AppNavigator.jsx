	...
	if (loadedAndLoggedIn.loaded == true && loadedAndLoggedIn.loggedIn == true) {
		...
		return (
			<Stack.Navigator initialRouteName="Login">
				<Stack.Screen name="Login" options={{ headerShown: false }} setLoadedAndLoggedIn={setLoadedAndLoggedIn}>
		...
		return (
			<Stack.Navigator initialRouteName="AppLoadingStack">
				<Stack.Screen name="AppLoading" options={{ headerShown: false }}>
