...
ActiveRecord::Schema.define(version: 2019_05_13_192001) do
  ...
  create_table "follows", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["followee_id"], name: "index_follows_on_chef_id"
    t.index ["follower_id"], name: "index_follows_on_chef_id"
  end
  ...
  create_table "friendships", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["acceptor_id"], name: "index_friendships_on_chef_id"
    t.index ["requestor_id"], name: "index_friendships_on_chef_id"
  end
